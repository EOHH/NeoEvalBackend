...
public interface CourseModuleRepository extends JpaRepository<CourseModule, Long> {
    ...
    List<CourseModule> findByTeacherId(Long teacherId);

    // Buscar todos los módulos asociados a una asignatura específica
    List<CourseModule> findBySubjectId(Long subjectId);
     ...
     */
    @Query("SELECT DISTINCT cm FROM CourseModule cm " +
    ...
    List<CourseModule> findModulesByStudentId(@Param("studentId") Long studentId);
}